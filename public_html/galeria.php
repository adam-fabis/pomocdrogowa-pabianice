...
<!-- GALLERY:START -->
      ...
      <button type="button" class="gal-cell gal-more" data-shot="10" data-full="/assets/img/laweta-z-przyczepa-transport-ulica-pabianice.jpg" aria-label="Powiększ zdjęcie: Laweta z przyczepą w transporcie ulicą — Pabianice">
      ...
      <button type="button" class="gal-cell gal-more" data-shot="11" data-full="/assets/img/czerwone-auto-na-lawecie-osiedle-pabianice.jpg" aria-label="Powiększ zdjęcie: Czerwone auto na lawecie na osiedlu — holowanie Pabianice">
      ...
      <button type="button" class="gal-cell gal-more" data-shot="12" data-full="/assets/img/laweta-transport-auta-droga-ekspresowa-pabianice.jpg" aria-label="Powiększ zdjęcie: Laweta transportuje auto drogą ekspresową — pomoc drogowa Pabianice">
      ...
      <button type="button" class="gal-cell gal-more" data-shot="13" data-full="/assets/img/mobilny-serwis-samochodowy-van-pabianice.jpg" aria-label="Powiększ zdjęcie: Van mobilnego serwisu samochodowego Pomoc Drogowa Pabianice">
